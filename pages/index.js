        ...
        <section className="min-h-screen">
          <nav className="py-10 mb-10 flex justify-between">
            ...
            <ul className="flex items-center">
              ...
              <li><a href='#' className="bg-gradient-to-r from-cyan-600 to-teal-500  text-white rounded-md py-2 px-4 ml-8">Resume</a></li>
            </ul>
          </nav>
          <div className="text-center p-10">
            <h2 className="text-5xl font-medium text-teal-600 py-2">Dimitri Marco</h2>
            <h3 className="text-2xl py-2">Developer and designer.</h3>
            <p className="text-md py-10 leading-8 md:text-xl max-w-lg mx-auto dark:text-white">Freelancer providing services for programming and design content
          ...
          <div className="relative  mx-auto bg-gradient-to-b from-cyan-600 0 rounded-full w-80 h-80 mt-20 overflow-hidden md:h-100 md:w-100 md:h-100">
